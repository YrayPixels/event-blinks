                ...
                <section className="hero py-4 h-screen">
                    <div className="hero-content space-y-8">
                        ...
                        <div className="my-2 flex flex-row justify-center items-center">
                            <a target="_blank" href={`${process.env.NEXT_PUBLIC_HOST_URL}/blink-wrapper?generated=${process.env.NEXT_PUBLIC_HOST_URL}/api/events/create`} className="px-10 py-3 text-white rounded-xl bg-[#ED3A4F] hover:bg-[#60DEE8] cta-button ">Get Started</a>
                        </div>
                    </div>
