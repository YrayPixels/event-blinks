...
const BlinksWrapper = () => {
    ...
    const actionApiUrl = 'https://www.quick-blinks.xyz/api/events/create';
    ...
    return (
        <div className='bg-[url("/grid_bg.png")] h-screen flex flex-row justify-center items-center'>
            <div className='absolute top-5 right-10'> <button className='bg-white hover:bg-white/50 hover:text-white text-black p-2 shadow-lg rounded-xl'>
                Connect Dscvr
            </button></div>
